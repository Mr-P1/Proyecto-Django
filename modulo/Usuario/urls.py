...
from .views import eliminar_suscriptor,admin,suscripcion,desuscribirse,registrarse,iniciarsesion,admin,eliminarSuscriptor,ingresarSuscriptor, usuario_json,vigencia,principalUsuario,listar,cerrar_sesion,listaCategoria
...
urlpatterns = [
    ...
    path('listarCat/<idCate>/',listaCategoria,name='listaCategoria'),
    path('usuario-json/', usuario_json , name="usuario_json"),
