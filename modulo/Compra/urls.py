...
from .views import eliminar_producto ,vaciarCarro ,mas,menos,listarSeguimiento,cambiarSeguimiento
urlpatterns = [
    path('carroCompra',carroCompra,name='carroCompra'),
    path('agregar/<int:producto_id>',agregar_carrito,name='agregar'),
    path('agregar2/<int:producto_id>',agregar_carrito2,name='agregar2'),
    ...
    path('cambiar/<int:idSeguimiento>',cambiarSeguimiento,name='cambiarSeguimiento')
